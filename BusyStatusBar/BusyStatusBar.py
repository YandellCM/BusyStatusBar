        ...
        rx.vstack(
            ...
            rx.hstack(
                rx.image(
                    ...
                    alt="Busy Status Bar",
                    class_name="w-1/2 rounded-2xl shadow-md object-cover"
                ),
                rx.box(
                    rx.text(
                        "Busy Status Bar",
                        class_name="font-bold text-3xl text-gray-900 mb-3"
                    ),
                    rx.text(
                        ...
                        class_name="text-gray-600 max-w-md mb-4"
                    ),
                    rx.button(
                        "BUY",
                        class_name="mt-4 bg-orange-500 text-white px-6 py-2 rounded-full shadow hover:bg-orange-600 transition"
                    ),
                    class_name="flex flex-col items-center text-center"
                ),
                class_name="flex flex-col md:flex-row items-center gap-8 mb-16"
            ),
